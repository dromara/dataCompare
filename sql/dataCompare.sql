...
-- ----------------------------
INSERT INTO `db_config` VALUES ('9', 'test1112', 'MySQL', 'jdbc:mysql://10.71.7.89:3306', 'root', '123456', '2022-11-30 07:07:03', 'admin');
...
-- ----------------------------
INSERT INTO `job_config` VALUES ('8', 'test_db.user_info', 'id', 'name,age', 'test_db.user_info', 'id', 'name,age', '9', '2022-12-06 12:54:04', null, '1', 'admin', 'where name=\'xiaomi\'', 'where name=\'xiaomi\'', 'group by name', 'group by name');
INSERT INTO `job_config` VALUES ('9', 'test_db.user_info', 'id', 'name,age', 'test_db.user_info', 'id', 'name,age', '9', '2022-12-06 12:56:33', null, '1', 'admin', 'where name=\'xiaomi\'', 'where name=\'xiaomi\'', 'group by name', 'group by name');
...
-- ----------------------------
INSERT INTO `job_instance` VALUES ('3', '8', '1', '1', '1', '1', '0', '0', 'select base.pv,\n       verify.pv as verify_pv,\n       base.pv - verify.pv as diff_pv,\n       base.uv,\n       verify.uv as verify_uv,\n       base.uv - verify.uv as diff_uv\n  from (\n        select \'num\' as compareKey,\n               count(1) as pv,\n               count(distinct id) as uv\n          from test_db.user_info\n         where name=\'xiaomi\'\n       )base\n  left outer join (\n        select \'num\' as compareKey,\n               count(1) as pv,\n               count(distinct id) as uv\n          from test_db.user_info\n         where name=\'xiaomi\'\n       )verify\n    on base.compareKey=verify.compareKey', '1', '1', '0', 'select compareKey,sum(base_num) as base_num,sum(verify_num) as verify_num,sum(base_verify_equal_num) as base_verify_equal_num from (\n\nselect Coalesce(base.compareKey, verify.compareKey) as compareKey,\n       sum(case when base.record_key is not null or base.record_key !=\'\' then 1 else 0 end) as base_num,\n       sum(case when verify.record_key is not null or verify.record_key !=\'\' then 1 else 0 end) as verify_num,\n       sum(case when base.record_key = verify.record_key then 1 else 0 end) as base_verify_equal_num\n  from (\n        select \'consistency\' as compareKey,\n               MD5(concat(if(id is null, \'-\', id),if(name is null, \'-\', name),if(age is null, \'-\', age))) as record_key\n          from test_db.user_info\n         where name=\'xiaomi\'\n       )base\n  left join (\n        select \'consistency\' as compareKey,\n               MD5(concat(if(id is null, \'-\', id),if(name is null, \'-\', name),if(age is null, \'-\', age))) as record_key\n          from test_db.user_info\n          where name=\'xiaomi\'\n       )verify\n    on base.compareKey=verify.compareKey\n   and base.record_key=verify.record_key\n group by Coalesce(base.compareKey, verify.compareKey)\n\nUNION\n\nselect Coalesce(base.compareKey, verify.compareKey) as compareKey,\n       sum(case when base.record_key is not null or base.record_key !=\'\' then 1 else 0 end) as base_num,\n       sum(case when verify.record_key is not null or verify.record_key !=\'\' then 1 else 0 end) as verify_num,\n       sum(case when base.record_key = verify.record_key then 1 else 0 end) as base_verify_equal_num\n  from (\n        select \'consistency\' as compareKey,\n               MD5(concat(if(id is null, \'-\', id),if(name is null, \'-\', name),if(age is null, \'-\', age))) as record_key\n          from test_db.user_info\n          where name=\'xiaomi\'\n       )base\n  right join (\n        select \'consistency\' as compareKey,\n               MD5(concat(if(id is null, \'-\', id),if(name is null, \'-\', name),if(age is null, \'-\', age))) as record_key\n          from test_db.user_info\n         where name=\'xiaomi\'\n       )verify\n    on base.compareKey=verify.compareKey\n   and base.record_key=verify.record_key\n group by Coalesce(base.compareKey, verify.compareKey)\n\n) t GROUP BY compareKey', null, '2022-12-12 09:07:02');
INSERT INTO `job_instance` VALUES ('4', '9', '1', '1', '1', '1', '0', '0', 'select base.pv,\n       verify.pv as verify_pv,\n       base.pv - verify.pv as diff_pv,\n       base.uv,\n       verify.uv as verify_uv,\n       base.uv - verify.uv as diff_uv\n  from (\n        select \'num\' as compareKey,\n               count(1) as pv,\n               count(distinct id) as uv\n          from test_db.user_info\n         where name=\'xiaomi\'\n       )base\n  left outer join (\n        select \'num\' as compareKey,\n               count(1) as pv,\n               count(distinct id) as uv\n          from test_db.user_info\n         where name=\'xiaomi\'\n       )verify\n    on base.compareKey=verify.compareKey', '1', '1', '1', 'select compareKey,sum(base_num) as base_num,sum(verify_num) as verify_num,sum(base_verify_equal_num) as base_verify_equal_num from (\n\nselect Coalesce(base.compareKey, verify.compareKey) as compareKey,\n       sum(case when base.record_key is not null or base.record_key !=\'\' then 1 else 0 end) as base_num,\n       sum(case when verify.record_key is not null or verify.record_key !=\'\' then 1 else 0 end) as verify_num,\n       sum(case when base.record_key = verify.record_key then 1 else 0 end) as base_verify_equal_num\n  from (\n        select \'consistency\' as compareKey,\n               MD5(concat(if(id is null, \'-\', id),if(name is null, \'-\', name),if(age is null, \'-\', age))) as record_key\n          from test_db.user_info\n         where name=\'xiaomi\'\n       )base\n  left join (\n        select \'consistency\' as compareKey,\n               MD5(concat(if(id is null, \'-\', id),if(name is null, \'-\', name),if(age is null, \'-\', age))) as record_key\n          from test_db.user_info\n          where name=\'xiaomi\'\n       )verify\n    on base.compareKey=verify.compareKey\n   and base.record_key=verify.record_key\n group by Coalesce(base.compareKey, verify.compareKey)\n\nUNION\n\nselect Coalesce(base.compareKey, verify.compareKey) as compareKey,\n       sum(case when base.record_key is not null or base.record_key !=\'\' then 1 else 0 end) as base_num,\n       sum(case when verify.record_key is not null or verify.record_key !=\'\' then 1 else 0 end) as verify_num,\n       sum(case when base.record_key = verify.record_key then 1 else 0 end) as base_verify_equal_num\n  from (\n        select \'consistency\' as compareKey,\n               MD5(concat(if(id is null, \'-\', id),if(name is null, \'-\', name),if(age is null, \'-\', age))) as record_key\n          from test_db.user_info\n          where name=\'xiaomi\'\n       )base\n  right join (\n        select \'consistency\' as compareKey,\n               MD5(concat(if(id is null, \'-\', id),if(name is null, \'-\', name),if(age is null, \'-\', age))) as record_key\n          from test_db.user_info\n         where name=\'xiaomi\'\n       )verify\n    on base.compareKey=verify.compareKey\n   and base.record_key=verify.record_key\n group by Coalesce(base.compareKey, verify.compareKey)\n\n) t GROUP BY compareKey', null, '2022-12-12 09:07:33');
INSERT INTO `job_instance` VALUES ('5', '8', '1', '1', '1', '1', '0', '0', 'select base.pv,\n       verify.pv as verify_pv,\n       base.pv - verify.pv as diff_pv,\n       base.uv,\n       verify.uv as verify_uv,\n       base.uv - verify.uv as diff_uv\n  from (\n        select \'num\' as compareKey,\n               count(1) as pv,\n               count(distinct id) as uv\n          from test_db.user_info\n         where name=\'xiaomi\'\n       )base\n  left outer join (\n        select \'num\' as compareKey,\n               count(1) as pv,\n               count(distinct id) as uv\n          from test_db.user_info\n         where name=\'xiaomi\'\n       )verify\n    on base.compareKey=verify.compareKey', '1', '1', '1', 'select compareKey,sum(base_num) as base_num,sum(verify_num) as verify_num,sum(base_verify_equal_num) as base_verify_equal_num from (\n\nselect Coalesce(base.compareKey, verify.compareKey) as compareKey,\n       sum(case when base.record_key is not null or base.record_key !=\'\' then 1 else 0 end) as base_num,\n       sum(case when verify.record_key is not null or verify.record_key !=\'\' then 1 else 0 end) as verify_num,\n       sum(case when base.record_key = verify.record_key then 1 else 0 end) as base_verify_equal_num\n  from (\n        select \'consistency\' as compareKey,\n               MD5(concat(if(id is null, \'-\', id),if(name is null, \'-\', name),if(age is null, \'-\', age))) as record_key\n          from test_db.user_info\n         where name=\'xiaomi\'\n       )base\n  left join (\n        select \'consistency\' as compareKey,\n               MD5(concat(if(id is null, \'-\', id),if(name is null, \'-\', name),if(age is null, \'-\', age))) as record_key\n          from test_db.user_info\n          where name=\'xiaomi\'\n       )verify\n    on base.compareKey=verify.compareKey\n   and base.record_key=verify.record_key\n group by Coalesce(base.compareKey, verify.compareKey)\n\nUNION\n\nselect Coalesce(base.compareKey, verify.compareKey) as compareKey,\n       sum(case when base.record_key is not null or base.record_key !=\'\' then 1 else 0 end) as base_num,\n       sum(case when verify.record_key is not null or verify.record_key !=\'\' then 1 else 0 end) as verify_num,\n       sum(case when base.record_key = verify.record_key then 1 else 0 end) as base_verify_equal_num\n  from (\n        select \'consistency\' as compareKey,\n               MD5(concat(if(id is null, \'-\', id),if(name is null, \'-\', name),if(age is null, \'-\', age))) as record_key\n          from test_db.user_info\n          where name=\'xiaomi\'\n       )base\n  right join (\n        select \'consistency\' as compareKey,\n               MD5(concat(if(id is null, \'-\', id),if(name is null, \'-\', name),if(age is null, \'-\', age))) as record_key\n          from test_db.user_info\n         where name=\'xiaomi\'\n       )verify\n    on base.compareKey=verify.compareKey\n   and base.record_key=verify.record_key\n group by Coalesce(base.compareKey, verify.compareKey)\n\n) t GROUP BY compareKey', null, '2022-12-12 09:15:06');
INSERT INTO `job_instance` VALUES ('6', '8', '1', '1', '1', '1', '0', '0', 'select base.pv,\n       verify.pv as verify_pv,\n       base.pv - verify.pv as diff_pv,\n       base.uv,\n       verify.uv as verify_uv,\n       base.uv - verify.uv as diff_uv\n  from (\n        select \'num\' as compareKey,\n               count(1) as pv,\n               count(distinct id) as uv\n          from test_db.user_info\n         where name=\'xiaomi\'\n       )base\n  left outer join (\n        select \'num\' as compareKey,\n               count(1) as pv,\n               count(distinct id) as uv\n          from test_db.user_info\n         where name=\'xiaomi\'\n       )verify\n    on base.compareKey=verify.compareKey', '1', '1', '1', 'select compareKey,sum(base_num) as base_num,sum(verify_num) as verify_num,sum(base_verify_equal_num) as base_verify_equal_num from (\n\nselect Coalesce(base.compareKey, verify.compareKey) as compareKey,\n       sum(case when base.record_key is not null or base.record_key !=\'\' then 1 else 0 end) as base_num,\n       sum(case when verify.record_key is not null or verify.record_key !=\'\' then 1 else 0 end) as verify_num,\n       sum(case when base.record_key = verify.record_key then 1 else 0 end) as base_verify_equal_num\n  from (\n        select \'consistency\' as compareKey,\n               MD5(concat(if(id is null, \'-\', id),if(name is null, \'-\', name),if(age is null, \'-\', age))) as record_key\n          from test_db.user_info\n         where name=\'xiaomi\'\n       )base\n  left join (\n        select \'consistency\' as compareKey,\n               MD5(concat(if(id is null, \'-\', id),if(name is null, \'-\', name),if(age is null, \'-\', age))) as record_key\n          from test_db.user_info\n          where name=\'xiaomi\'\n       )verify\n    on base.compareKey=verify.compareKey\n   and base.record_key=verify.record_key\n group by Coalesce(base.compareKey, verify.compareKey)\n\nUNION\n\nselect Coalesce(base.compareKey, verify.compareKey) as compareKey,\n       sum(case when base.record_key is not null or base.record_key !=\'\' then 1 else 0 end) as base_num,\n       sum(case when verify.record_key is not null or verify.record_key !=\'\' then 1 else 0 end) as verify_num,\n       sum(case when base.record_key = verify.record_key then 1 else 0 end) as base_verify_equal_num\n  from (\n        select \'consistency\' as compareKey,\n               MD5(concat(if(id is null, \'-\', id),if(name is null, \'-\', name),if(age is null, \'-\', age))) as record_key\n          from test_db.user_info\n          where name=\'xiaomi\'\n       )base\n  right join (\n        select \'consistency\' as compareKey,\n               MD5(concat(if(id is null, \'-\', id),if(name is null, \'-\', name),if(age is null, \'-\', age))) as record_key\n          from test_db.user_info\n         where name=\'xiaomi\'\n       )verify\n    on base.compareKey=verify.compareKey\n   and base.record_key=verify.record_key\n group by Coalesce(base.compareKey, verify.compareKey)\n\n) t GROUP BY compareKey', null, '2022-12-12 09:17:49');
