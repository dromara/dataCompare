...
;layui.define(["laytpl", "laypage", "layer", "form", "util"], function (e) {
    ...
    var t = layui.$, i = layui.laytpl, a = layui.laypage, l = layui.layer, n = layui.form,
        ...
        m = ".layui-table-tool", g = ".layui-table-box", b = ".layui-table-init",
        x = ".layui-table-header", k = ".layui-table-body", C = ".layui-table-main",
        w = ".layui-table-fixed", T = ".layui-table-fixed-l", A = ".layui-table-fixed-r",
        L = ".layui-table-total", N = ".layui-table-page", S = ".layui-table-sort",
    ...
    j.prototype.config = {
        ...
        var c = this, s = c.config, y = e[s.response.dataName] || [], h = [], v = [], m = [],
            g = function () {
                var e;
        ...
        var e, i = this, a = i.config, o = t("body"), c = {}, s = i.layHeader.find("th"),
            h = ".layui-table-cell", p = a.elem.attr("lay-filter");
                    ...
                    s({
                        list: function () {
                            ...
                            n.on("checkbox(LAY_TABLE_TOOL_COLS)", function (e) {
                                var l = t(e.elem), n = this.checked, o = l.data("key"),
                                    r = l.data("parentkey");
        ...
        var v = function (e) {
            var a = t(this), l = a.parents("tr").eq(0).data("index"),
        ...
        i.layBody.on("change", "." + W, function () {
            var e = t(this), a = this.value, l = e.parent().data("field"),
                n = e.parents("tr").eq(0).data("index"), o = d.cache[i.key][n];
            ...
            var e, a = t(this), l = this, n = a.parent().data("field"),
                o = a.parents("tr").eq(0).data("index"), r = d.cache[i.key][o];
