...
!function () {
    ...
    var grammar = function () {
        ...
        var parser = {
            ...
            table: [{
                ...
                15: [2, 7],
                23: [2, 7]
            }, {5: [2, 8], 8: [2, 8], 9: [2, 8], 13: [2, 8], 15: [2, 8], 23: [2, 8]}, {
                14: 15,
                30: [1, 16]
                ...
                28: [2, 20],
                29: [2, 20]
            }, {23: [2, 21], 28: [2, 21], 29: [2, 21]}, {10: 29, 23: [1, 13]}, {
                10: 31,
                18: 30,
                23: [1, 13]
            }, {23: [2, 14]}, {23: [2, 15]}, {
                14: 32,
                30: [1, 16]
            }, {23: [2, 18]}, {23: [2, 22]}, {23: [2, 23]}, {14: 33, 30: [1, 16]}, {
                14: 34,
                30: [1, 16]
            }, {19: [1, 35], 30: [2, 12]}, {
                5: [2, 16],
            ...
            parse: function (input) {
                ...
                var self = this, stack = [0], vstack = [null], lstack = [], table = this.table,
                    yytext = "", yylineno = 0, yyleng = 0, recovering = 0, TERROR = 2, EOF = 1;
    ...
    var DIAGRAM_MARGIN = 10, ACTOR_MARGIN = 10, ACTOR_PADDING = 10, SIGNAL_MARGIN = 5,
        SIGNAL_PADDING = 5, NOTE_MARGIN = 10, NOTE_PADDING = 5, NOTE_OVERLAP = 15, TITLE_MARGIN = 0,
        TITLE_PADDING = 5, SELF_SIGNAL_WIDTH = 20, PLACEMENT = Diagram.PLACEMENT,
        LINETYPE = Diagram.LINETYPE, ARROWTYPE = Diagram.ARROWTYPE,
    ...
    AssertException.prototype.toString = function () {
        ...
        var wobble = Math.sqrt((x2 - x1) * (x2 - x1) + (y2 - y1) * (y2 - y1)) / 25,
            r1 = Math.random(), r2 = Math.random(), xfactor = Math.random() > .5 ? wobble : -wobble,
        ...
        var path = this.print(x, y, string, font, size, "baseline", letter_spacing),
            bb = path.getBBox(), dx = x - bb.x - bb.width / 2, dy = y - bb.y - bb.height / 2,
    ...
    _.extend(BaseTheme.prototype, {
        init: function (diagram) {
            ...
            var diagram = this.diagram, paper = this._paper, font = this._font,
                actors = diagram.actors, signals = diagram.signals;
            ...
            var line,
                attr = _.extend({}, LINE, {"stroke-dasharray": this.line_types[signal.linetype]}),
            ...
            var aX = getCenterX(signal.actorA), bX = getCenterX(signal.actorB),
                x = (bX - aX) / 2 + aX, y = offsetY + SIGNAL_MARGIN + 2 * SIGNAL_PADDING;
            ...
            var x = box.x + margin, y = box.y + margin, w = box.width - 2 * margin,
                h = box.height - 2 * margin, rect = this.draw_rect(x, y, w, h);
